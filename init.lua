...
-- Basic Mappings
api.nvim_set_keymap('n', '<leader><leader>', ':source $MYVIMRC <CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', 'k', "v:count == 0 ? 'gk' : 'k'", { noremap = true, expr = true, silent = true }) --Remap for dealing with word wrap
vim.api.nvim_set_keymap('n', 'j', "v:count == 0 ? 'gj' : 'j'", { noremap = true, expr = true, silent = true }) --Remap for dealing with word wrap
vim.api.nvim_set_keymap('n', '<C-h>', "gT <CR>", { noremap = true, silent = true }) --Remap for dealing with word wrap
vim.api.nvim_set_keymap('n', '<C-l>', "gt <CR>", { noremap = true, silent = true }) --Remap for dealing with word wrap
